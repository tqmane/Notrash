---
title: "Essential Spaceの解析"
description: "2.1.7の構成、AIサービス、Voiceとの関係。"
keywords: [Notrash, Wiki, essential-space]
---

`com.nothing.ntessentialspace` は Essential Space の画面に加え、共通の AI サービス実装も含む。今回の Essential Voice の設定画面・音声入力サービス本体は、別パッケージの [Essential Recorder](/wiki/essential-recorder) にある。
...
Notrash 側: `EssentialVoiceHooks.java`
