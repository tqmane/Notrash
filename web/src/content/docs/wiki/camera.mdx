---
title: "Nothing Cameraの解析"
description: "16.0.01.26.00のシャッター音制御と、Notrashのフック。"
keywords: [Notrash, Wiki, camera]
---
...
再実行: `python verification/smoke.py`。画面記録: [camera-on.png](/images/camera-on.png)。
...
[全体の導入手順](/docs/overview) · [Essential Recorder](/wiki/essential-recorder) · [Essential Space](/wiki/essential-space)
